...
import { Typography, Card, Row, Col, Button, Pagination, message, Spin, Tag } from "antd";
...
const AuctionsPage = () => {
  ...
  return (
    <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
      <Title level={2} style={{ marginBottom: "20px" }}>Ongoing Auctions</Title>
